...
data_version='_v3.3'
experiment = "/experiments/Pix2Pix_SelfAtten_"+dataset+"_"+mode+data_version+"_"+datetime.datetime.now().strftime("%Y%m%d-%H%M%S")+"/"  # 
...
fit(train_dataset, test_dataset, steps=step_size)  #100000 or 52 epochs
